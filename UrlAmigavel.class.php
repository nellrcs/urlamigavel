...
class UrlAmigavel
{
	...
	public static function gera_htaccess($dir = null)
	{
		...
		$htaccess.="RewriteRule ^sitemap.xml$ sitemap.php [L]"."\r\n";
	...
	# concatena id mais o titulo (nome)
	public static function linkAmigavel($id,$titulo)
	{
	    ...
	    $mapping = array_combine($i[0], $v[0]);
	    return $id."-".strtolower(str_replace(" ", "-", strtr($titulo, $mapping)) );
	}

	public static function linkAmigavelDecode($url)
	{
		$id = explode("-", $url);
		return (int)$id[0];
	}
